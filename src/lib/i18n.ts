...
export const translations = {
  ru: {
    ...
    // QR Codes
    qr: {
      createTitle: "Создать QR код",
      createSubtitle:
        "Создайте QR код, который позволит другим отправлять запросы на прогнозы",
      availableCredits: "Доступные кредиты",
      creditsHint:
        "Максимальное количество использований не может превышать ваши доступные кредиты.",
      expirationDate: "Дата истечения (необязательно)",
      expirationHint: "Оставьте пустым для бессрочного действия",
      maxUses: "Максимальное количество использований",
      maxUsesHint: "Максимальное количество раз, которое можно использовать этот QR код",
      createButton: "Создать QR код",
      manageTitle: "Мои QR коды",
      manageSubtitle: "Управляйте своими QR кодами и просматривайте статистику",
      createNew: "Создать новый",
      createFirst: "Создать первый QR код",
      emptyTitle: "Пока нет QR кодов",
      emptyDescription:
        "Создайте свой первый QR код, чтобы позволить другим отправлять запросы на прогнозы",
      qrCode: "QR код",
      createdAt: "Создан",
      expiresAt: "Истекает",
      uses: "Использований",
      ...
      formTitle: "Форма запроса прогноза",
      formSubtitle: "Заполните форму ниже, чтобы отправить запрос на прогноз Таро",
      submitButton: "Отправить запрос",
      successTitle: "Запрос отправлен успешно!",
      successMessage:
        "Ваш запрос на прогноз отправлен. Прогноз будет сгенерирован и отправлен создателю QR кода.",
    },
    // Mantra
    mantra: {
      title: "Личная мантра",
...
- Вывод должен быть похож на отчет о диагностике судьбы.`,
    ...
    loadingPhrases: {
      ...
      "mechanical-prophet": {
        ...
        imageAnalysis: [
          "Сканирование входных параметров…",
          "Данные рождения синхронизированы.",
          "Визуальный уровень энергии обнаружен.",
          "Обработка данных изображения…",
          "Анализ биометрических паттернов…",
          "Энергетический подпись зарегистрирована.",
        ],
        textGeneration: [
          "Обработка набора данных Таро…",
          "Вычисление вероятностей исхода…",
          "Генерация прогноза в процессе…",
          "Распознавание паттернов: активно.",
          "Вероятностная матрица: вычисление…",
          "Статистический анализ: 87% завершено.",
          "Синтез данных: в процессе.",
          "Предсказание исхода: генерация…",
          "Компиляция отчета: завершение.",
          "Прогноз готов: ожидание отображения.",
        ],
      },
    },
  },
  en: {
    ...
    qr: {
      ...
      activate: "Activate",
      formTitle: "Tarot Reading Request Form",
...
- Structure the answer with clear bullets and percentages.`,
  ...
  by: {
    ...
    // QR Codes
    qr: {
      createTitle: "Стварыць QR код",
      createSubtitle:
        "Стварыце QR код, які дазволіць іншым адпраўляць запыты на прагнозы",
      availableCredits: "Даступныя крэдыты",
      creditsHint:
        "Максімальная колькасць выкарыстанняў не можа перавышаць вашы даступныя крэдыты.",
      expirationDate: "Дата заканчэння (неабавязкова)",
      expirationHint: "Пакіньце пустым для бестэрміновага дзеяння",
      maxUses: "Максімальная колькасць выкарыстанняў",
      maxUsesHint: "Максімальная колькасць разоў, якую можна выкарыстаць гэты QR код",
      createButton: "Стварыць QR код",
      manageTitle: "Мае QR коды",
      manageSubtitle: "Кіруйце сваімі QR кодамі і праглядайце статыстыку",
      createNew: "Стварыць новы",
      createFirst: "Стварыць першы QR код",
      emptyTitle: "Пакуль няма QR кодаў",
      emptyDescription:
        "Стварыце свой першы QR код, каб дазволіць іншым адпраўляць запыты на прагнозы",
      qrCode: "QR код",
      createdAt: "Створаны",
      expiresAt: "Сканчваецца",
      uses: "Выкарыстанняў",
      readings: "Прагнозаў",
      statusActive: "Актыўны",
      statusInactive: "Неактыўны",
      statusExpired: "Скончыўся",
      statusLimitReached: "Ліміт дасягнуты",
      deactivate: "Дэактываваць",
      activate: "Актываваць",
      formTitle: "Форма запыту прагнозу",
      formSubtitle: "Запоўніце форму ніжэй, каб адправіць запыт на прагноз Таро",
      submitButton: "Адправіць запыт",
      successTitle: "Запыт адпраўлены паспяхова!",
      successMessage:
        "Ваш запыт на прагноз адпраўлены. Прагноз будзе згенераваны і адпраўлены стваральніку QR кода.",
    },
    // Mantra
    mantra: {
